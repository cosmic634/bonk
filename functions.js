...
function setup(){
    ...
    graph2 = new Graph();
    graph2.colorFunction = color(204,0,204);  
...
//    println("lets do this");
    ...
    text("Velocity",0.8*width,0.8*height+75);
        fill(0,0,255);
    text("Forces",0.8*width,0.8*height+50); 
    fill(204,0,204);
    text("Acceleration",0.8*width,0.8*height+25);
    }
...
function drawBlob( _x,  _y, _vx, _vy, _ax, _ay, _blob_radius ){
    strokeWeight(2);
    //    fill(255);
    noFill();
    stroke(0);
...
function drawForce( _x,  _y, _Fx, _Fy){
    strokeWeight(2);
    //    fill(255);
    noFill();
    var tri_width=7;
